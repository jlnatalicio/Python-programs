...
icon = pygame.image.load('res/img/space-invaders.png').convert_alpha()
pygame.display.set_icon(icon)

# Create Background
# ("Sound made by BloodPixelHero from www.freesound.org")
background_img = pygame.image.load('res/img/background.png').convert_alpha()
mixer.music.load('res/sounds/background.wav')
mixer.music.play(-1)

# Create Player
player_img = pygame.image.load('res/img/player.png').convert_alpha()
...
bullet_img = pygame.image.load('res/img/bullet.png').convert_alpha()
bullet_x = 0.0
bullet_y = player_y
bullet_y_change = 0.3
bullet_state = "ready"                                                           
...
for i in range(num_enemies):
      enemy_img.append(pygame.image.load('res/img/alien1.png').convert_alpha()) 
